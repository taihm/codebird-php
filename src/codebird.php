...
class Codebird
{
  ...
  protected static $_api_methods = [
    'GET' => [
      ...
      'ads/accounts/:account_id/cards/video_website',
      'ads/accounts/:account_id/cards/video_website/:card_id',
      ...
      'ads/sandbox/accounts/:account_id/cards/video_website',
      'ads/sandbox/accounts/:account_id/cards/video_website/:card_id',
